<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="MC-Channels.aspx.cs" Inherits="WebApplication1.Structural_Products.Channels.MC_Channnels" %>
        ...
        <div class="RightColumn">
            ...
            <div id="breadcrumbs">
                <ul>
                    ...
                    <li><a href="mc-channels.aspx" class="current">MC Channels</a></li>
                </ul>
            </div>
            <div class="clear"></div>

            <div class="col1 margintop1">
                <img src="../../images/mc-channels-main.jpg" alt="MC Channels" title="MC Channels" class="main" />
                <h4 title="MC Channels">MC Channels</h4>
                <p>Also known as miscellaneous channels and junior channels, MC Channels are channels that cannot be classified as C shapes. They generally are similar to C Channels except they possess flange slopes less than that of C Channels. MC channels are commonly used to mount, brace, support, and connect lightweight structural loads in buildings. They are also frequently used for frames and braces in applications such as tractor trailers, racking, and heavy duty equipment and machinery.​ Other commons applications include purlins, girts, diaphrams, stiffeners, and ribs.</p>
                ...
                <table class="One desktop">
                    <tbody>
                        ...
                        <tr>
                            <td class="right left bottom">10 - 12 in. </td>
                            <td class="right bottom">Depth</td>
                        </tr>
                        <tr>
                            <td class="right left bottom">6.5 – 14.3 lbs/ft.</td>
                            <td class="right bottom">Lbs./Ft.</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="More">
                <ul>
                    ...
                    <li>
                        <p>
                            SDI Steel of West Virginia produces MC channels ranging from 3x7.1# – 8x22.8#.<br>
        ...
        <aside class="sidebar">
            ...
            <div class="sideNav">
                <ul>
                    ...
                    <li><a href="mc-channels.aspx" title="MC Channels" class="current">MC Channels</a></li>
                </ul>
            </div>
            <div class="catalog">
