<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="Standard-I-Beams.aspx.cs" Inherits="WebApplication1.Structural_Products.beams.Stabdard_I_Beans" %>
        ...
        <div class="RightColumn">
            ...
            <div id="breadcrumbs">
                <ul>
                    ...
                    <li><a href="standard-i-beams.aspx" class="current">Standard I-Beams</a></li>
                </ul>
            </div>
            <div class="clear"></div>

            <div class="col1 margintop1">
                <img src="../../images/standard-i-beams-main.jpg" alt="Standard I-Beams" title="Standard I-Beams" class="main" />
                <h4 title="Standard I-Beams">Standard I-Beams</h4>
                <p>We produce a wide range of hot-rolled Standard I-Beams. They are also referred to as S-beams, I-beams, Junior Beams, and American standard beams. The distinguishing feature of these shapes is that the inside flange surfaces have approximately a sixteen and two-thirds percent slope or taper. The tapered flanges result in the increased strengths of flanges. Standard I-Beams are most commonly used by original equipment manufacturers in the construction of machines and equipment columns for trolley ways, lifts and hoists, maritime platforms, mezzanines, trailer and truck-bed framing, and overhead cranes and monorails.</p>
                ...
                <table class="One desktop">
                    <tbody>
                        ...
                        <tr>
                            <td class="right left bottom">12 - 24 in. </td>
                            <td class="right bottom">Depth</td>
                        </tr>
                        <tr>
                            <td class="right left bottom">31.8 - 121 Lbs./Ft.</td>
            ...
            <div class="More">
                <ul>
                    ...
                    <li>
                        <p>
                            SDI Steel of West Virginia produces Standard I-Beams ranging from S3x3.5.7# to S6x17.25#.<br>
        ...
        <aside class="sidebar">
            ...
            <div class="sideNav">
                <ul>
                    ...
                    <li><a href="standard-i-beams.aspx" title="Standard I-Beams" class="current">Standard I-Beams</a></li>
