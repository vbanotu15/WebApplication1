<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="Freight-Rate.aspx.cs" Inherits="WebApplication1.Customer.Freight_Rate" %>
        ...
        <ContentTemplate>
            <div class="content">
                ...
                <div class="RightColumn">
                    ...
                    <div class="col1">
                        <div class="col1 margintop1">
                            <h4 title="Freight Rate">Freight Rate</h4>
                ...
                <aside class="sidebar">
                    ...
                    <div class="sideNav">
                        <ul>
                            <li><a href="Customer-Utilities.aspx" title="Overview" >Customer Utilities</a></li>
                            <li><a href="Reporting.aspx" title="Price List" class="">Reporting</a></li>
                            <li><a href="Freight-Rate.aspx" title="Price List" class="current">Freight Rate</a></li>
